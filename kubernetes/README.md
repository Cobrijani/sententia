...
```
$ kubectl get svc sentway -n sententia
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n sententia
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n sententia
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n sententia
```

and explore the details using

```
$ kubectl get svc exposed-registry -n sententia
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n sententia
```
